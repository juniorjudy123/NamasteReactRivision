	...
	const resList = [
		{
			...
			analytics: {
				context: "seo-data-19cb9169-c846-464c-9d3d-fb735dd1eed5",
			},
			cta: {
		...
		},
		{
			info: {
				...
				availability: {
					nextCloseTime: "2024-06-25 22:25:00",
					opened: true,
				},
				badges: {
					imageBadges: [
		...
		},
		{
			...
			cta: {
				link: "https://www.swiggy.com/restaurants/aasife-biryani-ernakulam-panampilly-nagar-kochi-498923",
				text: "RESTAURANT_MENU",
				type: "WEBLINK",
			},
			widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	...
	return (
		<div>
			...
			<div className="res-container">
				{resList.map((res) => (
					<ResContainerComponent resData={res} />
				))}
			</div>
		</div>
	)
